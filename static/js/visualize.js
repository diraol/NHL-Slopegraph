...
$.getJSON('static/data.json', function(data) {
  ...
  var onSelectChanged = function(){
    ...
    if(parseInt(leftIndex) <= parseInt(centerIndex) && parseInt(centerIndex) <= parseInt(rightIndex)){
      ...
      renderStandings(chart,leftData,centerData,rightData,{'key':conferenceKey,'title':conferenceText});
    }
  }
  ...
  //initial rendering of the graph
    renderStandings(chart,leftData,centerData,rightData,{'key':'westernConference','title':'Western Conference'});
});

function renderStandings(chart,left,center,right,conferenceName){
  ...
  var rightDate = right.date;
    ...
    //if the title group exists, just change the text values
      ...
      titleGroup.select('#centerDate').text(centerDate);
  ...
  */
  ...
  centerTeams.attr('fill',function(d,i){if(i<8) return playoffColor;else return nonPlayoffColor;}) //make the playoff bound teams standout
    .transition()
    .duration(transitionDuration)
    .attr('y', function(d,i){return d.yCoord;});
  ...
  slopeLines.enter().append("line")
    ...
    .attr('y2',function(d,i){return d.center - (teamBuffer/2);})
    .attr('opacity', .5)
    .attr('stroke', 'black');
  ...
  centerEndPoints
    ...
    .size(function(d) { return 20; })
    .type(function(d) { return "circle"; }))
    .attr("transform", function(d) { return "translate(345," + (d.center-(teamBuffer/2)) + ")"; });

  centerEndPoints.transition().duration(transitionDuration).attr("transform", function(d) { return "translate(345," + (d.center-(teamBuffer/2)) + ")"; });
  ...
  slopeLines2.enter().append("line")
    .attr('x1', 520)
    .attr('x2', 645)
    .attr('y1',function(d,i){return d.center - (teamBuffer/2);})
  ...
  centerEndPoints2
    ...
    .size(function(d) { return 20; })
    .type(function(d) { return "circle"; }))
    .attr("transform", function(d) { return "translate(520," + (d.center-(teamBuffer/2)) + ")"; });

  centerEndPoints2.transition().duration(transitionDuration).attr("transform", function(d) { return "translate(520," + (d.center-(teamBuffer/2)) + ")"; });
  ...
  rightEndPoints
    ...
    .size(function(d) { return 20; })
    .type(function(d) { return "circle"; }))
    .attr("transform", function(d) { return "translate(645," + (d.right-(teamBuffer/2)) + ")"; });

  rightEndPoints.transition().duration(transitionDuration).attr("transform", function(d) { return "translate(645," + (d.right-(teamBuffer/2)) + ")"; });
